...
import { Menu, X, Eye, Wallet, Image, Compass, Bot, Brain, Shield, FileCode, BarChart3, Gamepad2, Github, Terminal } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/omega-deep', label: 'Agent', icon: Terminal },
];
